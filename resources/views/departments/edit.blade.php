        ...
        <div class="card-block">
            ...
            <form method="POST" action="{{ route('departments.store') }}">
                ...
                <div class="form-group row">
                    ...
                    >
                    <div class="col-sm-10">
                        <input type="text" value="{{ $department->department }}" name="department" id="department" class="form-control @error('department') is-invalid @enderror" placeholder="e.g Accounts" required="" />
                    </div>
                    @error('department')
