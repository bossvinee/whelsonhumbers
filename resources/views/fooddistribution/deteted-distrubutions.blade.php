...
Showing All Deleted Food Distributions
@endsection
        ...
        <div class="col-lg-8">
            <div class="page-header-title">
                <div class="d-inline">
                    ...
                    <span class="pcoded-mtext"> Deleted food distributions</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header" style="margin-bottom: 0;padding-bottom:0;">
                                <h4 style="font-size:16px;margin-bottom:0;">Showing all deleted food distributions</h4>
                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @endif
                                                    <span
                                                        class="badge badge-{{$badgeClass}}">{{ $distribution->status }}</span>
                                                </td>
                                                <td>{{ $distribution->done_by }}</td>
                                                <td style="white-space: nowrap;width:20%;">

                                                    <form method="POST" action="{{ route('deleted-fdistributions.update',$distribution->id) }}" role="form" class="d-inline">
                                                        @csrf
                                                        @method('PUT')
                                                        <button type="submit" data-toggle="tooltip" title="Restore Distribution" class="btn btn-success btn-sm d-inline"><i
                                                                class="fa fa-pencil"></i></button>
                                                    </form>

                                                    <form method="POST"
                                                        action="{{ route('deleted-fdistributions.destroy',$distribution->id) }}"
                                                        class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button class="d-inline btn-sm btn btn-danger"
                                                            data-toggle="tooltip"
                                                            title="Permanent Delete Distribution"><i
